...
class TestAuth(BaseTestCase):
    ...
    def test_user_class(self):
        user = User(1,"KASULE","kasule@gmail.com","kansanga",1234)
        self.assertTrue(user)

    def test_details_json_format(self):
        with self.client:
            result = self.signup_user("kasule","kasule@gmail.com","kansanga","1234")
    ...
    def test_short_password(self):
        ...
        """
        with self.client:
            result = self.signup_user("kasule","kasule@gmail.com","kansanga","124")
    ...
    def test_username_is_string(self):
        ...
        """
        with self.client:
            result = self.signup_user(1234,"kasule@gmail.com","kansanga","1246575")
            self.assertEqual(result.status_code, 202)
            data = json.loads(result.data.decode())
    ...
    def test_spaces_in_username(self):
        ...
        """
        with self.client:
            result = self.signup_user("     ","kasule@gmail.com","kansanga","1246575")
    ...
    def test_user_already_exist(self):
        with self.client:
            self.signup_user("kasule","kasule@gmail.com","kansanga","123464")
            result = self.signup_user("kasule","kasule@gmail.com","kansanga","12ht34")
    ...
    def test_successful_login(self):
        with self.client:
            self.signup_user("kasule","kasule@gmail.com","kansanga","12389894")
            response = self.login_user("kasule","12389894")
            res = json.loads(response.data.decode())
            self.assertEqual(response.status_code,200)
            self.assertTrue(res['username'] == 'kasule')
            self.assertEqual("You have succesfully logged in.",str(res['message']))
    ...
    def test_login_credentials(self):
        with self.client:
            ...
            self.assertEqual('Check your username or password',str(res['message']))
    
    def test_successful_signup(self):
        with self.client:
            result = self.signup_user("kasule","kasule@gmail.com","kansanga","12347809")
            self.assertEqual(result.status_code,201)
            res = json.loads(result.data.decode())
            self.assertTrue(res['status'] == 'Success')
            self.assertEqual('User account successfully created, log in',str(res['message']))